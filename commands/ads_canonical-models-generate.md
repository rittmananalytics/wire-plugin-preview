...
event = {
    ...
    'command': 'ads_canonical-models-generate',
...
preconditions:
  - artifact: governance_design
    action: review
    outcome: approved
auto_validate: false          # validate runs dbt test --select tag:canonical, dbt compile, and dbt ls against the real warehouse
delegates_to:
