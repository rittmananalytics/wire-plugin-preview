...
- **338 slash commands** covering the full delivery lifecycle: Discovery (Shape Up + RA Canonical SOP), Requirements, Design, Development, Testing, Deployment, Enablement, Platform Migration, Agentic Data Stack
...
- [Command Reference](docs-site/docs/reference/commands.md) — command catalog and conventions (run `/wire:help` for the full, current list of all 338 commands)
